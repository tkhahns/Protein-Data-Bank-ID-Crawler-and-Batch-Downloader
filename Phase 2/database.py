...
main_table_attributes = Attributes[extract.MainData]\
    ([entry_id, ("complex_type", "VARCHAR(25) NOT NULL"), ("source_organism", "VARCHAR(200)"),
      ("chains", "VARCHAR"), ("space_group", "VARCHAR(20)"), ("Z_value", "INT"), ("a", "FLOAT"),
      ("b", "FLOAT"), ("c", "FLOAT"), ("alpha", "FLOAT"), ("beta", "FLOAT"), ("gamma", "FLOAT")],
...
strand_table_attributes = Attributes[extract.StrandData]\
    ([entry_id, sheet_id, ("strand_id", "VARCHAR(5) NOT NULL"), chain_id,
      ...
      foreign_keys={"entry_id": ("main", "entry_id"), "sheet_id": ("sheets", "sheet_id"), "chain_id": ("chains", "chain_id")})
strand_table = Table("strands", strand_table_attributes, extract.insert_into_strand_table)

table_schemas: list[Table] = [main_table, entity_table, chain_table, subchain_table, helix_table, sheet_table, strand_table]
